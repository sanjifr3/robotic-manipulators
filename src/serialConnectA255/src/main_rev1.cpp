...
int main(int argc, char **argv)
{
	...
	MatrixXd XYZi(14,3);//Initial Position Matrix
	MatrixXd XYZf(14,3);//Final Position Matrix
    MatrixXd DesThi(14,5);//Initial invK Matrix
    MatrixXd DesThf(14,5);//Final invK Matrix
    ...
    //Initial Coordinates
    	...
    	XYZi(4,0) = XYZi(9,0) = XiSt + 4*a+40;

    	//Initial Y Coordinates
    	XYZi(0,1) = XYZi(1,1) = XYZi(2,1) = XYZi(3,1) = XYZi(4,1) = YiSt + a + s;
    	XYZi(5,1) = XYZi(6,1) = XYZi(7,1) = XYZi(8,1) = XYZi(9,1) = YiSt - s;
    	XYZi(10,1) = XYZi(11,1) = XYZi(12,1) = XYZi(13,1) = YiSt - a - 3*s;
