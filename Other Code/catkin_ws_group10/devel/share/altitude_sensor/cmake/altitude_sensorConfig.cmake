...
if("TRUE" STREQUAL "TRUE")
  set(altitude_sensor_SOURCE_PREFIX /home/me-547/catkin_ws_group10/src/me545-codes/lightware_alt_sensor/altitude_sensor)
  set(altitude_sensor_DEVEL_PREFIX /home/me-547/catkin_ws_group10/devel)
  ...
  set(altitude_sensor_INSTALL_PREFIX /home/me-547/catkin_ws_group10/install)
...
if(NOT "/home/me-547/catkin_ws_group10/devel/include " STREQUAL " ")
  set(altitude_sensor_INCLUDE_DIRS "")
  set(_include_dirs "/home/me-547/catkin_ws_group10/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'altitude_sensor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/me-547/catkin_ws_group10/src/me545-codes/lightware_alt_sensor/altitude_sensor/${idir}'.  Ask the maintainer 'timo <timo@todo.todo>' to fix it.")
    endif()
