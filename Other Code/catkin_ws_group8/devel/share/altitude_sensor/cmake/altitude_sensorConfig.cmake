...
if("TRUE" STREQUAL "TRUE")
  set(altitude_sensor_SOURCE_PREFIX /home/me-547/catkin_ws_group8/src/lightware_alt_sensor/altitude_sensor)
  set(altitude_sensor_DEVEL_PREFIX /home/me-547/catkin_ws_group8/devel)
  ...
  set(altitude_sensor_INSTALL_PREFIX /home/me-547/catkin_ws_group8/install)
...
if(NOT "/home/me-547/catkin_ws_group8/devel/include " STREQUAL " ")
  set(altitude_sensor_INCLUDE_DIRS "")
  set(_include_dirs "/home/me-547/catkin_ws_group8/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'altitude_sensor' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'timo <timo@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'altitude_sensor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/me-547/catkin_ws_group8/src/lightware_alt_sensor/altitude_sensor/${idir}'.  Ask the maintainer 'timo <timo@todo.todo>' to fix it.")
    endif()
...
set(altitude_sensor_EXPORTED_TARGETS "altitude_sensor_generate_messages_cpp;altitude_sensor_generate_messages_lisp;altitude_sensor_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${altitude_sensor_dep}_FOUND)
      find_package(${altitude_sensor_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${altitude_sensor_dep} REQUIRED ${depend_list})
  endif()
